...
var Diaspora = {
  ...
  PS: function () {
    console.log('[diaspora]', 'page-state');
  ...
  HS: function (tag, flag) {
    console.log('[diaspora]', 'history-state', tag, flag);
    ...
    Diaspora.L(url, function (data) {
      ...
      setTimeout(function () {
        Diaspora.player();
        $('#top').show();
        if ($("#gitalk-container") && $("#gitalk-container").data('ae') == true) {
          $("#gitalk-container").click();
        }
        if (window.giscusInit) {
          window.giscusInit(window, document);
        } else {
  ...
  player: function () {
    ...
    if (sourceSrc == '' && p[0].src == '') {
      ...
      mp3 = audiolist ? audiolist.eq([Math.floor(Math.random() * audiolist.length)]) : $('');
...
$(function () {
    ...
    switch (true) {
      ...
      case (tag.indexOf("comment") != -1):
        ...
        if ($('#gitalk-container').data('enable') == true) {
          ...
          Diaspora.loaded();
        } else if ($('#giscus-container').data('enable') == true) {
          Diaspora.loading();
          window.giscusInit(window, document);
          Diaspora.loaded();
        } else {
  ...
  console.log("%c      QQ %c", "background:#ff0000; color:#ffffff", "", 2601960221, "@whisperain");
  console.log("%c   Zhihu %c", "background:#0066ff; color:#ffffff", "", "https://www.zhihu.com/people/memset0");
  console.log("%c  Github %c", "background:#24272A; color:#ffffff", "", "https://github.com/memset0");
  console.log("%c   Theme %c", "background:#986DB2; color:#ffffff", "", "https://github.com/memset0/hexo-theme-diaspora");
})
